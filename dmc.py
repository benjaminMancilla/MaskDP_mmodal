...
def make(name, obs_type="states", frame_stack=1, action_repeat=1, seed=1, pixel_size=84):
    ...
    env = make_fn(obs_type, domain, task, frame_stack, action_repeat, seed, pixel_size)
